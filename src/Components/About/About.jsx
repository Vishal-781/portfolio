...
import VishalImage from "./../../Assets/images/dp_vishal.png";
      ...
      <div className={styles.container}>
        <div className={styles.left}>
          <div className={styles.imageContainer}>
            <img src={VishalImage} alt="Vishal Shrivatava" />
        ...
        <div className={styles.right}>
          ...
          <p ref={descriptionRef} className={styles.description}>
            ...
            taking on challenges. Originally from Datia, Madhya Pradesh,
          ...
          <div className={styles.infoContainer}>
            <div className={styles.info}>
              <h2>Name</h2>
              <p ref={nameRef}>Vishal Shrivatava</p>
            </div>
            <div className={styles.info}>
              <h2>Education</h2>
              <p ref={educationRef}>
            ...
            <div className={styles.info}>
              <h2>Email</h2>
              <p ref={emailRef}>officialworkvishal91@gmail.com</p>
            </div>
            <div className={styles.info}>
              <h2>Phone</h2>
              <p ref={phoneRef}>+91 7999819086</p>
            </div>
          </div>
        </div>
      </div>
